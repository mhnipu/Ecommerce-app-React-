            ...
            <div className="w-full bg-gray-100 pb-20">
                <form className="w-[350px] mx-auto flex flex-col items-center ">
                    ...
                    <Link className='w-full' to='/registration'>
                        <button className='w-full py-1.5 mt-4 text-sm font-normal rounded-lg bg-gradient-to-t from-slate-200 to-slate-100 hover:bg-gradient-to-b border border-zinc-400 active:border-app_yellow active:shadow-appShadow Hover'>Create your Amazon Account</button>
                    </Link>
                </form >
            </div >
