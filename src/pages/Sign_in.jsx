        ...
        <div className="w-full ">
            <div className="w-full bg-gray-100 pb-20">
                <form className="w-[350px] mx-auto flex flex-col items-center ">
                        ...
                        <div className='flex flex-col gap-3'>
                            ...
                            <div className='flex flex-col gap-2 py-1 relative'>
                                <p className='text-gray-500'>
                                    ...
                                    {showPassword ? (
                                        <Visibility
                                            className='absolute right-2 top-1/4 transform -translate-y-1/2 cursor-pointer'
                            ...
                            <button onClick={(e) => e.preventDefault()} className='mt-2 px-8 bg-gradient-to-tr from-yellow-400 to-yellow-300 border hover:from-yellow-300 hover:to-yellow-400 border-yellow-500 hover:border-yellow-600 active:bg-gradient-to-bl active:from-yellow-400 active:to-yellow-500 duration-500 py-1.5 rounded-md shadow-md hover:shadow-lg focus:outline-none transform transition-transform hover:scale-105 drop-shadow-lg'>Continue</button>
                        </div>
                        <div>
                            <p className='text-xs pt-4 group'>By Continuing you agree to <span className='font-semibold'>App`s </span><span className='text-blue-600 group-hover:text-orange-700 group-hover:underline cursor-pointer'>Conditions of Use {""}</span>and <span className='text-blue-600 group-hover:text-orange-700 group-hover:underline'>Privacy Notice.</span> </p>
                        </div>
                        <p className='text-xs mt-2 text-gray-600 cursor-pointer group'><ArrowRight className='' /><span className='text-blue-600 group-hover:text-orange-700 group-hover:underline'> Need help?</span></p>
                    </div>
                    ...
                    <button onClick={(e) => e.preventDefault()} className='w-full py-1.5 mt-4 text-sm font-normal rounded-lg bg-gradient-to-t from-slate-200 to-slate-100 hover:bg-gradient-to-b border border-zinc-400 active:border-app_yellow active:shadow-appShadow Hover'>Create your Amazon Account</button>
                </form >
            </div >
